...
from prompt import clarify_with_user_instructions, transform_messages_into_research_topic_prompt
...
model = init_chat_model(model="ollama:qwen3:14b", temperature=0.0)
